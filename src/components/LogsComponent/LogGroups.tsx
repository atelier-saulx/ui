...
const VerticalLine = styled('div', {
  height: '100%',
  width: '1px',
  backgroundColor: genColor('border', 'default'),
  position: 'absolute',
  left: 12,
  top: 0,
  bottom: 0,
...
const StatusDotBorder = styled('div', {
  ...
  backgroundColor: genColor('background', 'negative', 'subtle'),
})
    ...
    <styled.div style={{ display: 'flex', position: 'relative' }}>
      ...
      >
        <StatusDotBorder
          style={{
            backgroundColor:
              genColor('background', color, 'subtle') ??
              (status === 'error'
                ? genColor('background', 'negative', 'subtle')
                : status === 'succes'
                ? genColor('background', 'positive', 'subtle')
                : status === 'info'
                ? genColor('background', 'informative', 'subtle')
                : genColor('background', 'inverted', 'subtle')),
          }}
        >
          <StatusDot
            style={{
          ...
          {!expanded && subItems.length > 1 ? (
            ...
            >
              <IconChevronDown
                ...
                // size={12}
              />
              <Text color="default" light weight="strong">
    ...
    <styled.div>
        ...
        >
          <styled.div
            style={{
              ...
              borderRight: `1px solid ${genColor('border', 'default')}`,
            }}
          >
            <Text>{dayjs(ts).format('HH:mm:ss')} </Text>
            <Text light style={{ marginLeft: 4 }}>
      ...
      {msg[0] === '{' ? (
        ...
        <Text
          ...
          light
          color={status === 'error' ? 'negative' : 'default'}
        >
          {msg.split('\n')[0].substring(0, 74)}
        </Text>
      )}
      ...
      {idx === 0 && ts && (
        <styled.div style={{ display: 'flex' }}>
          <styled.div
            style={{
              display: 'flex',
              background: genColor('background', 'inverted', 'surface'),
              padding: '2px 8px',
