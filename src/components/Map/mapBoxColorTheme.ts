...
let landColor = convertToHSL(color('action', 'system', 'hover'))

console.log(landColor, '🫕')

let mapboxEl = document.getElementsByTagName('')
let test = getComputedStyle(document.documentElement).getPropertyValue('--vh')

console.log(test, 'yoW>/')
  ...
  layers: [
    {
      ...
      type: 'background',
      layout: {},
      paint: { 'background-color': 'hsla(255,50%,70%,0.4)' },
      metadata: {
