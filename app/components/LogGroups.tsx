...
import { LogGroups } from '../../src/components/LogsComponent/LogGroups'
  ...
  examples: [
    {
      ...
      customRenderer: () => {
        const dataForNewLogs = test.map(
          ({ srvc: type, lvl: status, ...rest }) => ({
            type,
            status,
            ...rest,
          })
        )
        return <LogGroups data={dataForNewLogs} groupByTime={15} />
      },
    },
  ],
}
